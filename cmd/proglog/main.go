...
import (
	...
	"github.com/stevequadros/proglog/internal/agent"
	"github.com/stevequadros/proglog/internal/config"
)
...
func setupFlags(cmd *cobra.Command) error {
	...
	cmd.Flags().StringSlice("start-and-join-addrs", nil, "Serf addresses to join.")
	...
	cmd.Flags().String("server-tls-ca-file", "", "Path to server tls authority.")

	cmd.Flags().String("peer-tls-cert-file", "", "Path to peer tls cert.")
	cmd.Flags().String("peer-tls-key-file", "", "Path to peer tls key.")
	cmd.Flags().String("peer-tls-ca-file", "", "Path to peer tls authority.")
...
func (c *cli) setupConfig(cmd *cobra.Command, args []string) error {
	...
	// its ok if config file doesn't exist
